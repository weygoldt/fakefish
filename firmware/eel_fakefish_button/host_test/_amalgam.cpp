...
//       -I <teensy4 core> -I firmware/eel_fakefish_button
//       firmware/eel_fakefish_button/host_test/_amalgam.cpp
//
// The host tests cover the PURE logic; this covers everything they cannot — the ISR, the HAL
// call signatures, the SD glue and every #include path — without needing a board. It is the
...
#include <Arduino.h>
#include "../eel_fakefish_button.ino"
